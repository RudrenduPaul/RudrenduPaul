...
|------|---------------|----------------------|
| [toolgovern](https://github.com/RudrenduPaul/toolgovern) | Runtime governance middleware gating shell/filesystem/network/credential access for AI agent tool calls<br><br>· CLI: `toolgovern-cli`<br>· npm: [toolgovern-cli](https://www.npmjs.com/package/toolgovern-cli)<br>· PyPI: [toolgovern-cli](https://pypi.org/project/toolgovern-cli/) | 1,782 |
| [ShimGuard](https://github.com/RudrenduPaul/ShimGuard) | Verifies a GitHub issue closed as "fixed" actually has a merged fix, with structured JSON output for CI/agents<br><br>· CLI: `shimguard`<br>· npm: [shimguard-cli](https://www.npmjs.com/package/shimguard-cli)<br>· PyPI: [shimguard-cli](https://pypi.org/project/shimguard-cli/) | 1,306 |
| [taskswarm](https://github.com/RudrenduPaul/taskswarm) | Pushes a local notification and live status page the instant a parallel Claude Code/Codex/Cursor session blocks or finishes<br><br>· CLI: `taskswarm`<br>· npm: [taskswarm-cli](https://www.npmjs.com/package/taskswarm-cli)<br>· PyPI: [taskswarm-cli](https://pypi.org/project/taskswarm-cli/) | 1,184 |
| [memtrust](https://github.com/RudrenduPaul/memtrust) | Independent benchmark harness for agent-memory backends (MemPalace, Mem0, Zep/Graphiti, OpenViking)<br><br>· CLI: `memtrust`<br>· npm: [memtrust-cli](https://www.npmjs.com/package/memtrust-cli)<br>· PyPI: [memtrust-cli](https://pypi.org/project/memtrust-cli/) | 1,130 |
| [auditreach](https://github.com/RudrenduPaul/auditreach) | BYOK CLI and MCP server for researching Reddit/YouTube with a tamper-evident, hash-chained audit log<br><br>· CLI: `auditreach`<br>· npm: [auditreach-cli](https://www.npmjs.com/package/auditreach-cli)<br>· PyPI: [auditreach-cli](https://pypi.org/project/auditreach-cli/) | 1,111 |
...
| [skillguard](https://github.com/RudrenduPaul/skillguard) | Security scanner for third-party AI agent-skill files, detecting cross-skill privilege chaining and prompt injection<br><br>· CLI: `skillguard-cli`<br>· npm: [skillguard-cli](https://www.npmjs.com/package/skillguard-cli)<br>· PyPI: [skillguard-cli](https://pypi.org/project/skillguard-cli/) | 990 |
| [InferBench](https://github.com/RudrenduPaul/InferBench) | Vendor-neutral local LLM inference benchmark reporting real, measured tokens/sec with agent-ready JSON output<br><br>· CLI: `inferbench`<br>· npm: [inferbench-cli](https://www.npmjs.com/package/inferbench-cli)<br>· PyPI: [inferbench-cli](https://pypi.org/project/inferbench-cli/) | 883 |
| [AgenticWorkspace](https://github.com/RudrenduPaul/AgenticWorkspace) | Converts any repo into an agent-ready workspace with progressive context and coding-agent adapters<br><br>· CLI: `agenticworkspace`<br>· npm: [agenticworkspace-cli](https://www.npmjs.com/package/agenticworkspace-cli)<br>· PyPI: [agenticworkspace-cli](https://pypi.org/project/agenticworkspace-cli/) | 837 |
| [slop-eval](https://github.com/RudrenduPaul/slop-eval) | Scores AI-generated UI for genericness with an LLM-judge rubric, for CI and agent quality gates<br><br>· CLI: `slop-eval`<br>· npm: [slop-eval-cli](https://www.npmjs.com/package/slop-eval-cli)<br>· PyPI: [slop-eval-cli](https://pypi.org/project/slop-eval-cli/) | 821 |
| [agent-observability](https://github.com/RudrenduPaul/agent-observability) | Deterministic record-and-replay for LLM agent HTTP traffic: record a failing run once, replay offline with zero API calls<br><br>· CLI: `agent-trace`<br>· npm: [agent-observability-trace-cli](https://www.npmjs.com/package/agent-observability-trace-cli)<br>· PyPI: [agent-observability-trace-cli](https://pypi.org/project/agent-observability-trace-cli/) | 812 |
| [podcast-guest-crm](https://github.com/RudrenduPaul/podcast-guest-crm) | Agent-native CRM for podcast guest booking with Claude-powered outreach drafting and a scriptable CLI<br><br>· CLI: `pgcrm`<br>· npm: [podcast-guest-crm-cli](https://www.npmjs.com/package/podcast-guest-crm-cli)<br>· PyPI: [podcast-guest-crm-cli](https://pypi.org/project/podcast-guest-crm-cli/) | 796 |
| [TokenTrust-CLI](https://github.com/RudrenduPaul/TokenTrust-CLI) | Verifies token/cost savings claimed by AI-coding-agent context-reduction proxies against a real labeled corpus<br><br>· CLI: `tokentrust`<br>· npm: [tokentrust-cli](https://www.npmjs.com/package/tokentrust-cli)<br>· PyPI: [tokentrust-cli](https://pypi.org/project/tokentrust-cli/) | 685 |
| [teamspend](https://github.com/RudrenduPaul/teamspend) | Compares AI coding tool spend before/after a migration, pulling real numbers from each vendor's API or local logs<br><br>· CLI: `teamspend`<br>· npm: [teamspend-cli](https://www.npmjs.com/package/teamspend-cli)<br>· PyPI: [teamspend-cli](https://pypi.org/project/teamspend-cli/) | 655 |
...
| [evolveguard](https://github.com/RudrenduPaul/evolveguard) | Regression-testing CI gate for self-edited Claude Agent Skills via golden-transcript record/replay<br><br>· CLI: `evolveguard`<br>· npm: [evolveguard-cli](https://www.npmjs.com/package/evolveguard-cli)<br>· PyPI: [evolveguard-cli](https://pypi.org/project/evolveguard-cli/) | 635 |
| [GraphKeeper](https://github.com/RudrenduPaul/GraphKeeper) | Mines git history for file co-change patterns and exposes them as a queryable graph for AI coding agents<br><br>· CLI: `graphkeeper`<br>· npm: [graphkeeper-cli](https://www.npmjs.com/package/graphkeeper-cli)<br>· PyPI: [graphkeeper-cli](https://pypi.org/project/graphkeeper-cli/) | 625 |
| [DeskCert-CLI](https://github.com/RudrenduPaul/DeskCert-CLI) | Certifies whether an AI agent is safe to operate a web app before production rollout, with an MCP server<br><br>· CLI: `deskcert`<br>· npm: [deskcert-cli](https://www.npmjs.com/package/deskcert-cli)<br>· PyPI: [deskcert-cli](https://pypi.org/project/deskcert-cli/) | 586 |
| [MasteryTrace](https://github.com/RudrenduPaul/MasteryTrace) | Fits Bayesian Knowledge Tracing/IRT models to learner logs for AI tutoring agents needing real mastery scoring<br><br>· CLI: `masterytrace`<br>· npm: [masterytrace-cli](https://www.npmjs.com/package/masterytrace-cli)<br>· PyPI: [masterytrace-cli](https://pypi.org/project/masterytrace-cli/) | 522 |
| [TenantGuard](https://github.com/RudrenduPaul/TenantGuard) | CLI/MCP scanner catching tenant-isolation defects in self-hosted multi-tenant AI-agent platforms<br><br>· CLI: `tenantguard`<br>· npm: [tenantguard-cli](https://www.npmjs.com/package/tenantguard-cli)<br>· PyPI: [tenantguard-cli](https://pypi.org/project/tenantguard-cli/) | 516 |
| [ownvoice](https://github.com/RudrenduPaul/ownvoice) | Trains a LoRA voice adapter for Kyutai's pocket-tts, kept as a local file instead of an API subscription, with `--json` output for agents and scripts<br><br>· CLI: `ownvoice`<br>· npm: [ownvoice-cli](https://www.npmjs.com/package/ownvoice-cli)<br>· PyPI: [ownvoice-cli](https://pypi.org/project/ownvoice-cli/) | 490 |
| [ComputeLedger](https://github.com/RudrenduPaul/ComputeLedger) | Signs, hash-chains, and verifies compute usage receipts across any cloud or on-prem provider<br><br>· CLI: `computeledger`<br>· npm: [computeledger-cli](https://www.npmjs.com/package/computeledger-cli)<br>· PyPI: [computeledger-cli](https://pypi.org/project/computeledger-cli/) | 448 |
| [swarmmesh](https://github.com/RudrenduPaul/swarmmesh) | Shared context/memory coordination layer for swarms of parallel AI agents, with a built-in MCP server<br><br>· CLI: `swarmmesh`<br>· npm: [swarmmesh-cli](https://www.npmjs.com/package/swarmmesh-cli)<br>· PyPI: [swarmmesh-cli](https://pypi.org/project/swarmmesh-cli/) | 428 |
| [ReleaseGuard](https://github.com/RudrenduPaul/ReleaseGuard) | Scans datasets/models for PII and secrets, generates compliance-ready model cards, with an MCP server for agent workflows<br><br>· CLI: `releaseguard-cli`<br>· npm: [releaseguard-cli](https://www.npmjs.com/package/releaseguard-cli)<br>· PyPI: [releaseguard-cli](https://pypi.org/project/releaseguard-cli/) | 304 |
| [HaltProof](https://github.com/RudrenduPaul/HaltProof) | Dry-run-by-default emergency shutdown orchestration for Slurm/K8s/IPMI clusters, with signed attestation logs<br><br>· CLI: `haltproof`<br>· npm: [haltproof-cli](https://www.npmjs.com/package/haltproof-cli)<br>· PyPI: [haltproof-cli](https://pypi.org/project/haltproof-cli/) | 303 |
| [agent-eval](https://github.com/RudrenduPaul/agent-eval) | Runs your agent 50x on version A vs. B and gives a p-value on whether behavior actually shifted<br><br>· CLI: `agent-regress-cli`<br>· npm: [agent-regress-cli](https://www.npmjs.com/package/agent-regress-cli)<br>· PyPI: [agent-regress-cli](https://pypi.org/project/agent-regress-cli/) | 213 |
| [PaceProof](https://github.com/RudrenduPaul/PaceProof) | Verifies Ed25519-signed compute-attestation records from any provider via CLI or MCP<br><br>· CLI: `paceproof`<br>· npm: [paceproof-cli](https://www.npmjs.com/package/paceproof-cli)<br>· PyPI: [paceproof-cli](https://pypi.org/project/paceproof-cli/) | 144 |
| [swarm-rd-orchestrator](https://github.com/RudrenduPaul/swarm-rd-orchestrator) | Ray-native context/memory sharing for parallel research agents (early milestone spike)<br><br>· CLI: `swarm-rd-cli`<br>· npm: [swarm-rd-orchestrator-cli](https://www.npmjs.com/package/swarm-rd-orchestrator-cli)<br>· PyPI: [swarm-rd-orchestrator-cli](https://pypi.org/project/swarm-rd-orchestrator-cli/) | 138 |
| [NeuronScope](https://github.com/RudrenduPaul/NeuronScope) | CLI/MCP server for mechanistic interpretability: traces which attention heads and neurons drive an LLM's output<br><br>· PyPI: [neuronscope-cli](https://pypi.org/project/neuronscope-cli/) | PyPI only |
