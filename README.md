...
| [#2810](https://github.com/openai/openai-cookbook/pull/2810) | **OpenAI Cookbook**&nbsp;·&nbsp;12K&nbsp;⭐ | feat(examples): structured extraction from PDFs with GPT-4o vision + Pydantic validation loop (rebased, moved into `examples/multimodal/` per repo convention; awaiting re-review) |
...
| [#2812](https://github.com/openai/openai-cookbook/pull/2812) | **OpenAI Cookbook**&nbsp;·&nbsp;12K&nbsp;⭐ | feat(examples): error handling and retry patterns for OpenAI API, tenacity, fallback, header inspection (rebased; 6 reviewer findings resolved across 2 rounds, verified with a full notebook execution; awaiting re-review) |
