...
- **Agentic Native Open Source Software (OSS) / Developer Community Contributions**
  - [Agent-Native Tools](#user-content-open-source-agent-native-tools): 30+ self-built CLIs, MCP servers, and libraries, 35k+ downloads across [npm](https://www.npmjs.com/~rudrendu_paul_packages) and [PyPI](https://pypi.org/user/Rudrendu/), also launched on [Product Hunt](https://www.producthunt.com/@rudrendu_paul_ai/activity)
...
|------|---------------|:----------------------:|
| [toolgovern](https://github.com/RudrenduPaul/toolgovern) | Runtime governance middleware gating shell/filesystem/network/credential access for AI agent tool calls<br><br>· CLI: `toolgovern-cli`<br>· npm: [toolgovern-cli](https://www.npmjs.com/package/toolgovern-cli)<br>· PyPI: [toolgovern-cli](https://pypi.org/project/toolgovern-cli/)<br>· MCP: [mcpservers.org](https://mcpservers.org/servers/rudrendupaul/toolgovern), [Glama.ai](https://glama.ai/mcp/servers/RudrenduPaul/toolgovern) | 2,144 |
| [agent-observability](https://github.com/RudrenduPaul/agent-observability) | Deterministic record-and-replay for LLM agent HTTP traffic: record a failing run once, replay offline with zero API calls<br><br>· CLI: `agent-trace`<br>· npm: [agent-observability-trace-cli](https://www.npmjs.com/package/agent-observability-trace-cli)<br>· PyPI: [agent-observability-trace-cli](https://pypi.org/project/agent-observability-trace-cli/)<br>· MCP: [mcpservers.org](https://mcpservers.org/servers/rudrendupaul/agent-observability), [Glama.ai](https://glama.ai/mcp/servers/RudrenduPaul/agent-observability) | 1,907 |
| [memtrust](https://github.com/RudrenduPaul/memtrust) | Independent benchmark harness for agent-memory backends (MemPalace, Mem0, Zep/Graphiti, OpenViking)<br><br>· CLI: `memtrust`<br>· npm: [memtrust-cli](https://www.npmjs.com/package/memtrust-cli)<br>· PyPI: [memtrust-cli](https://pypi.org/project/memtrust-cli/)<br>· MCP: [mcpservers.org](https://mcpservers.org/servers/rudrendupaul/memtrust), [Glama.ai](https://glama.ai/mcp/servers/RudrenduPaul/memtrust) | 1,842 |
| [skillguard](https://github.com/RudrenduPaul/skillguard) | Security scanner for third-party AI agent-skill files, detecting cross-skill privilege chaining and prompt injection<br><br>· CLI: `skillguard-cli`<br>· npm: [skillguard-cli](https://www.npmjs.com/package/skillguard-cli)<br>· PyPI: [skillguard-cli](https://pypi.org/project/skillguard-cli/)<br>· MCP: [mcpservers.org](https://mcpservers.org/servers/rudrendupaul/skillguard), [Glama.ai](https://glama.ai/mcp/servers/RudrenduPaul/skillguard) | 1,842 |
| [ShimGuard](https://github.com/RudrenduPaul/ShimGuard) | Verifies a GitHub issue closed as "fixed" actually has a merged fix, with structured JSON output for CI/agents<br><br>· CLI: `shimguard`<br>· npm: [shimguard-cli](https://www.npmjs.com/package/shimguard-cli)<br>· PyPI: [shimguard-cli](https://pypi.org/project/shimguard-cli/)<br>· MCP: [mcpservers.org](https://mcpservers.org/servers/rudrendupaul/shimguard), [Glama.ai](https://glama.ai/mcp/servers/RudrenduPaul/ShimGuard) | 1,777 |
| [LLMScout](https://github.com/RudrenduPaul/LLMScout) | Runs 21 technical-SEO and GEO checks to verify whether AI systems can find and cite your site, no headless browser required<br><br>· CLI: `llmscout`<br>· npm: [llmscout-cli](https://www.npmjs.com/package/llmscout-cli)<br>· PyPI: [llmscout-cli](https://pypi.org/project/llmscout-cli/)<br>· MCP: [mcpservers.org](https://mcpservers.org/servers/rudrendupaul/llmscout), [Glama.ai](https://glama.ai/mcp/servers/RudrenduPaul/LLMScout) | 1,693 |
| [auditreach](https://github.com/RudrenduPaul/auditreach) | BYOK CLI and MCP server for researching Reddit/YouTube with a tamper-evident, hash-chained audit log<br><br>· CLI: `auditreach`<br>· npm: [auditreach-cli](https://www.npmjs.com/package/auditreach-cli)<br>· PyPI: [auditreach-cli](https://pypi.org/project/auditreach-cli/)<br>· MCP: [mcpservers.org](https://mcpservers.org/servers/rudrendupaul/auditreach), [Glama.ai](https://glama.ai/mcp/servers/RudrenduPaul/auditreach) | 1,573 |
| [workspaceguard](https://github.com/RudrenduPaul/workspaceguard) | Per-workspace usage metering and fail-closed quota caps for a shared self-hosted AI assistant<br><br>· CLI: `workspaceguard`<br>· npm: [workspaceguard-cli](https://www.npmjs.com/package/workspaceguard-cli)<br>· PyPI: [workspaceguard-cli](https://pypi.org/project/workspaceguard-cli/)<br>· MCP: [mcpservers.org](https://mcpservers.org/servers/rudrendupaul/workspaceguard), [Glama.ai](https://glama.ai/mcp/servers/RudrenduPaul/WorkspaceGuard) | 1,558 |
| [taskswarm](https://github.com/RudrenduPaul/taskswarm) | Pushes a local notification and live status page the instant a parallel Claude Code/Codex/Cursor session blocks or finishes<br><br>· CLI: `taskswarm`<br>· npm: [taskswarm-cli](https://www.npmjs.com/package/taskswarm-cli)<br>· PyPI: [taskswarm-cli](https://pypi.org/project/taskswarm-cli/)<br>· MCP: [mcpservers.org](https://mcpservers.org/servers/rudrendupaul/taskswarm), [Glama.ai](https://glama.ai/mcp/servers/RudrenduPaul/taskswarm) | 1,547 |
| [InferBench](https://github.com/RudrenduPaul/InferBench) | Vendor-neutral local LLM inference benchmark reporting real, measured tokens/sec with agent-ready JSON output<br><br>· CLI: `inferbench`<br>· npm: [inferbench-cli](https://www.npmjs.com/package/inferbench-cli)<br>· PyPI: [inferbench-cli](https://pypi.org/project/inferbench-cli/)<br>· MCP: [mcpservers.org](https://mcpservers.org/servers/rudrendupaul/inferbench), [Glama.ai](https://glama.ai/mcp/servers/RudrenduPaul/InferBench) | 1,445 |
| [podcast-guest-crm](https://github.com/RudrenduPaul/podcast-guest-crm) | Agent-native CRM for podcast guest booking with Claude-powered outreach drafting and a scriptable CLI<br><br>· CLI: `pgcrm`<br>· npm: [podcast-guest-crm-cli](https://www.npmjs.com/package/podcast-guest-crm-cli)<br>· PyPI: [podcast-guest-crm-cli](https://pypi.org/project/podcast-guest-crm-cli/)<br>· MCP: [mcpservers.org](https://mcpservers.org/servers/rudrendupaul/podcast-guest-crm), [Glama.ai](https://glama.ai/mcp/servers/RudrenduPaul/podcast-guest-crm) | 1,417 |
| [AgenticWorkspace](https://github.com/RudrenduPaul/AgenticWorkspace) | Converts any repo into an agent-ready workspace with progressive context and coding-agent adapters<br><br>· CLI: `agenticworkspace`<br>· npm: [agenticworkspace-cli](https://www.npmjs.com/package/agenticworkspace-cli)<br>· PyPI: [agenticworkspace-cli](https://pypi.org/project/agenticworkspace-cli/)<br>· MCP: [mcpservers.org](https://mcpservers.org/servers/rudrendupaul/agenticworkspace), [Glama.ai](https://glama.ai/mcp/servers/RudrenduPaul/AgenticWorkspace) | 1,296 |
| [TokenTrust-CLI](https://github.com/RudrenduPaul/TokenTrust-CLI) | Verifies token/cost savings claimed by AI-coding-agent context-reduction proxies against a real labeled corpus<br><br>· CLI: `tokentrust`<br>· npm: [tokentrust-cli](https://www.npmjs.com/package/tokentrust-cli)<br>· PyPI: [tokentrust-cli](https://pypi.org/project/tokentrust-cli/)<br>· MCP: [mcpservers.org](https://mcpservers.org/servers/rudrendupaul/tokentrust), [Glama.ai](https://glama.ai/mcp/servers/RudrenduPaul/TokenTrust) | 1,275 |
| [DeskCert-CLI](https://github.com/RudrenduPaul/DeskCert-CLI) | Certifies whether an AI agent is safe to operate a web app before production rollout, with an MCP server<br><br>· CLI: `deskcert`<br>· npm: [deskcert-cli](https://www.npmjs.com/package/deskcert-cli)<br>· PyPI: [deskcert-cli](https://pypi.org/project/deskcert-cli/)<br>· MCP: [mcpservers.org](https://mcpservers.org/servers/rudrendupaul/deskcert-cli), [Glama.ai](https://glama.ai/mcp/servers/RudrenduPaul/DeskCert-CLI) | 1,268 |
| [slop-eval](https://github.com/RudrenduPaul/slop-eval) | Scores AI-generated UI for genericness with an LLM-judge rubric, for CI and agent quality gates<br><br>· CLI: `slop-eval`<br>· npm: [slop-eval-cli](https://www.npmjs.com/package/slop-eval-cli)<br>· PyPI: [slop-eval-cli](https://pypi.org/project/slop-eval-cli/)<br>· MCP: [mcpservers.org](https://mcpservers.org/servers/rudrendupaul/slop-eval), [Glama.ai](https://glama.ai/mcp/servers/RudrenduPaul/slop-eval) | 1,250 |
| [agent-eval](https://github.com/RudrenduPaul/agent-eval) | Runs your agent 50x on version A vs. B and gives a p-value on whether behavior actually shifted<br><br>· CLI: `agent-regress-cli`<br>· npm: [agent-regress-cli](https://www.npmjs.com/package/agent-regress-cli)<br>· PyPI: [agent-regress-cli](https://pypi.org/project/agent-regress-cli/)<br>· MCP: [mcpservers.org](https://mcpservers.org/servers/rudrendupaul/agent-eval), [Glama.ai](https://glama.ai/mcp/servers/RudrenduPaul/agent-eval) | 1,215 |
| [evolveguard](https://github.com/RudrenduPaul/evolveguard) | Regression-testing CI gate for self-edited Claude Agent Skills via golden-transcript record/replay<br><br>· CLI: `evolveguard`<br>· npm: [evolveguard-cli](https://www.npmjs.com/package/evolveguard-cli)<br>· PyPI: [evolveguard-cli](https://pypi.org/project/evolveguard-cli/)<br>· MCP: [mcpservers.org](https://mcpservers.org/servers/rudrendupaul/evolveguard), [Glama.ai](https://glama.ai/mcp/servers/RudrenduPaul/evolveguard) | 1,136 |
| [teamspend](https://github.com/RudrenduPaul/teamspend) | Compares AI coding tool spend before/after a migration, pulling real numbers from each vendor's API or local logs<br><br>· CLI: `teamspend`<br>· npm: [teamspend-cli](https://www.npmjs.com/package/teamspend-cli)<br>· PyPI: [teamspend-cli](https://pypi.org/project/teamspend-cli/)<br>· MCP: [mcpservers.org](https://mcpservers.org/servers/rudrendupaul/teamspend), [Glama.ai](https://glama.ai/mcp/servers/RudrenduPaul/teamspend) | 1,087 |
| [GraphKeeper](https://github.com/RudrenduPaul/GraphKeeper) | Mines git history for file co-change patterns and exposes them as a queryable graph for AI coding agents<br><br>· CLI: `graphkeeper`<br>· npm: [graphkeeper-cli](https://www.npmjs.com/package/graphkeeper-cli)<br>· PyPI: [graphkeeper-cli](https://pypi.org/project/graphkeeper-cli/)<br>· MCP: [mcpservers.org](https://mcpservers.org/servers/rudrendupaul/graphkeeper), [Glama.ai](https://glama.ai/mcp/servers/RudrenduPaul/GraphKeeper) | 1,069 |
| [MasteryTrace](https://github.com/RudrenduPaul/MasteryTrace) | Fits Bayesian Knowledge Tracing/IRT models to learner logs for AI tutoring agents needing real mastery scoring<br><br>· CLI: `masterytrace`<br>· npm: [masterytrace-cli](https://www.npmjs.com/package/masterytrace-cli)<br>· PyPI: [masterytrace-cli](https://pypi.org/project/masterytrace-cli/)<br>· MCP: [mcpservers.org](https://mcpservers.org/servers/rudrendupaul/masterytrace), [Glama.ai](https://glama.ai/mcp/servers/RudrenduPaul/MasteryTrace) | 977 |
| [TenantGuard](https://github.com/RudrenduPaul/TenantGuard) | CLI/MCP scanner catching tenant-isolation defects in self-hosted multi-tenant AI-agent platforms<br><br>· CLI: `tenantguard`<br>· npm: [tenantguard-cli](https://www.npmjs.com/package/tenantguard-cli)<br>· PyPI: [tenantguard-cli](https://pypi.org/project/tenantguard-cli/)<br>· MCP: [mcpservers.org](https://mcpservers.org/servers/rudrendupaul/tenantguard), [Glama.ai](https://glama.ai/mcp/servers/RudrenduPaul/TenantGuard) | 974 |
| [ownvoice](https://github.com/RudrenduPaul/ownvoice) | Trains a LoRA voice adapter for Kyutai's pocket-tts, kept as a local file instead of an API subscription, with `--json` output for agents and scripts<br><br>· CLI: `ownvoice`<br>· npm: [ownvoice-cli](https://www.npmjs.com/package/ownvoice-cli)<br>· PyPI: [ownvoice-cli](https://pypi.org/project/ownvoice-cli/)<br>· MCP: [mcpservers.org](https://mcpservers.org/servers/rudrendupaul/ownvoice), [Glama.ai](https://glama.ai/mcp/servers/RudrenduPaul/ownvoice) | 874 |
| [ComputeLedger](https://github.com/RudrenduPaul/ComputeLedger) | Signs, hash-chains, and verifies compute usage receipts across any cloud or on-prem provider<br><br>· CLI: `computeledger`<br>· npm: [computeledger-cli](https://www.npmjs.com/package/computeledger-cli)<br>· PyPI: [computeledger-cli](https://pypi.org/project/computeledger-cli/)<br>· MCP: [mcpservers.org](https://mcpservers.org/servers/rudrendupaul/computeledger), [Glama.ai](https://glama.ai/mcp/servers/RudrenduPaul/ComputeLedger) | 844 |
| [swarmmesh](https://github.com/RudrenduPaul/swarmmesh) | Shared context/memory coordination layer for swarms of parallel AI agents, with a built-in MCP server<br><br>· CLI: `swarmmesh`<br>· npm: [swarmmesh-cli](https://www.npmjs.com/package/swarmmesh-cli)<br>· PyPI: [swarmmesh-cli](https://pypi.org/project/swarmmesh-cli/)<br>· MCP: [mcpservers.org](https://mcpservers.org/servers/rudrendupaul/swarmmesh), [Glama.ai](https://glama.ai/mcp/servers/RudrenduPaul/swarmmesh) | 803 |
| [ReleaseGuard](https://github.com/RudrenduPaul/ReleaseGuard) | Scans datasets/models for PII and secrets, generates compliance-ready model cards, with an MCP server for agent workflows<br><br>· CLI: `releaseguard-cli`<br>· npm: [releaseguard-cli](https://www.npmjs.com/package/releaseguard-cli)<br>· PyPI: [releaseguard-cli](https://pypi.org/project/releaseguard-cli/)<br>· MCP: [mcpservers.org](https://mcpservers.org/servers/rudrendupaul/releaseguard), [Glama.ai](https://glama.ai/mcp/servers/RudrenduPaul/ReleaseGuard) | 685 |
| [TruthRoute](https://github.com/RudrenduPaul/TruthRoute) | Cross-model divergence scoring CLI comparing OpenAI, Anthropic, and Gemini responses, with an MCP server for agent-to-agent use<br><br>· CLI: `truthroute`<br>· npm: [truthroute-cli](https://www.npmjs.com/package/truthroute-cli)<br>· MCP: [mcpservers.org](https://mcpservers.org/servers/rudrendupaul/truthroute), [Glama.ai](https://glama.ai/mcp/servers/RudrenduPaul/TruthRoute) | 637 |
| [HaltProof](https://github.com/RudrenduPaul/HaltProof) | Dry-run-by-default emergency shutdown orchestration for Slurm/K8s/IPMI clusters, with signed attestation logs<br><br>· CLI: `haltproof`<br>· npm: [haltproof-cli](https://www.npmjs.com/package/haltproof-cli)<br>· PyPI: [haltproof-cli](https://pypi.org/project/haltproof-cli/)<br>· MCP: [mcpservers.org](https://mcpservers.org/servers/rudrendupaul/haltproof), [Glama.ai](https://glama.ai/mcp/servers/RudrenduPaul/HaltProof) | 617 |
| [NeuronScope](https://github.com/RudrenduPaul/NeuronScope) | CLI/MCP server for mechanistic interpretability: traces which attention heads and neurons drive an LLM's output<br><br>· PyPI: [neuronscope-cli](https://pypi.org/project/neuronscope-cli/)<br>· MCP: [mcpservers.org](https://mcpservers.org/servers/rudrendupaul/neuronscope), [Glama.ai](https://glama.ai/mcp/servers/RudrenduPaul/NeuronScope) | 538 |
| [swarm-rd-orchestrator](https://github.com/RudrenduPaul/swarm-rd-orchestrator) | Ray-native context/memory sharing for parallel research agents (early milestone spike)<br><br>· CLI: `swarm-rd-cli`<br>· npm: [swarm-rd-orchestrator-cli](https://www.npmjs.com/package/swarm-rd-orchestrator-cli)<br>· PyPI: [swarm-rd-orchestrator-cli](https://pypi.org/project/swarm-rd-orchestrator-cli/)<br>· MCP: [mcpservers.org](https://mcpservers.org/servers/rudrendupaul/swarm-rd-orchestrator), [Glama.ai](https://glama.ai/mcp/servers/RudrenduPaul/swarm-rd-orchestrator) | 355 |
| [PaceProof](https://github.com/RudrenduPaul/PaceProof) | Verifies Ed25519-signed compute-attestation records from any provider via CLI or MCP<br><br>· CLI: `paceproof`<br>· npm: [paceproof-cli](https://www.npmjs.com/package/paceproof-cli)<br>· PyPI: [paceproof-cli](https://pypi.org/project/paceproof-cli/)<br>· MCP: [mcpservers.org](https://mcpservers.org/servers/rudrendupaul/paceproof), [Glama.ai](https://glama.ai/mcp/servers/RudrenduPaul/PaceProof) | 281 |
| [WorkloadTruth](https://github.com/RudrenduPaul/WorkloadTruth) | Classifies a GPU workload as inference or training from telemetry alone, no application changes required<br><br>· CLI: `workloadtruth`<br>· npm: [workloadtruth-cli](https://www.npmjs.com/package/workloadtruth-cli)<br>· PyPI: [workloadtruth-cli](https://pypi.org/project/workloadtruth-cli/)<br>· MCP: [mcpservers.org](https://mcpservers.org/servers/rudrendupaul/workloadtruth), [Glama.ai](https://glama.ai/mcp/servers/RudrenduPaul/WorkloadTruth) | — |
| [truesignal](https://github.com/RudrenduPaul/truesignal) | Threat and connector status checks for AI-agent-integrated systems<br><br>· CLI: `truesignal`<br>· npm: [truesignal-cli](https://www.npmjs.com/package/truesignal-cli)<br>· PyPI: [truesignal-cli](https://pypi.org/project/truesignal-cli/)<br>· MCP: [mcpservers.org](https://mcpservers.org/servers/rudrendupaul/truesignal), [Glama.ai](https://glama.ai/mcp/servers/RudrenduPaul/truesignal) | — |
| [ContinuityGuard](https://github.com/RudrenduPaul/ContinuityGuard) | Scans video clips for continuity errors (props, wardrobe, lighting) across a sequence<br><br>· CLI: `continuityguard`<br>· npm: [continuityguard-cli](https://www.npmjs.com/package/continuityguard-cli)<br>· PyPI: [continuityguard-cli](https://pypi.org/project/continuityguard-cli/)<br>· MCP: [mcpservers.org](https://mcpservers.org/servers/rudrendupaul/continuityguard), [Glama.ai](https://glama.ai/mcp/servers/RudrenduPaul/ContinuityGuard) | — |
| [freelancer-payment-protection](https://github.com/RudrenduPaul/freelancer-payment-protection) | Freelancer client payment-risk checks before taking on a new engagement<br><br>· CLI: `fpp`<br>· npm: [freelancer-payment-protection-cli](https://www.npmjs.com/package/freelancer-payment-protection-cli)<br>· PyPI: [freelancer-payment-protection-cli](https://pypi.org/project/freelancer-payment-protection-cli/)<br>· MCP: [mcpservers.org](https://mcpservers.org/servers/rudrendupaul/freelancer-payment-protection), [Glama.ai](https://glama.ai/mcp/servers/RudrenduPaul/freelancer-payment-protection) | — |
| [electronics-rfq-agent](https://github.com/RudrenduPaul/electronics-rfq-agent) | AI quoting agent that prices RFQ line items against your ERP via MCP connectors<br><br>not yet published | not yet published |
...
**✅ [pandas-dev/pandas #65291](https://github.com/pandas-dev/pandas/pull/65291) (merged)**
...
| [#733](https://github.com/anthropics/claude-cookbooks/pull/733) | **Anthropic Cookbook**&nbsp;·&nbsp;12K&nbsp;⭐ | feat(misc): Message Batches API, async batch submission, polling, result streaming, 50% cost savings (Reviewed by a non-maintainer; awaiting a real maintainer review) |
| [#2810](https://github.com/openai/openai-cookbook/pull/2810) | **OpenAI Cookbook**&nbsp;·&nbsp;12K&nbsp;⭐ | feat(examples): structured extraction from PDFs with GPT-4o vision + Pydantic validation loop (rebased, moved into `examples/multimodal/` per repo convention, 4 rounds of reviewer findings resolved, latest review clean; awaiting a human code-owner review) |
| [#2811](https://github.com/openai/openai-cookbook/pull/2811) | **OpenAI Cookbook**&nbsp;·&nbsp;12K&nbsp;⭐ | feat(examples): model routing, cheapest capable OpenAI model dispatch with tiktoken cost tracking (rebased onto latest main; awaiting re-review) |
| [#2812](https://github.com/openai/openai-cookbook/pull/2812) | **OpenAI Cookbook**&nbsp;·&nbsp;12K&nbsp;⭐ | feat(examples): error handling and retry patterns for OpenAI API, tenacity, fallback, header inspection (rebased; 18 reviewer findings resolved across 8 rounds, each verified with a full notebook execution in a clean virtualenv; awaiting re-review) |
| [#2813](https://github.com/openai/openai-cookbook/pull/2813) | **OpenAI Cookbook**&nbsp;·&nbsp;12K&nbsp;⭐ | feat(examples): multi-agent task decomposition, parallel specialists + asyncio.gather synthesis (rebased onto latest main; awaiting re-review) |
