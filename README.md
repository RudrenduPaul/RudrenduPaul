...
| [#2810](https://github.com/openai/openai-cookbook/pull/2810) | **OpenAI Cookbook** | 12K ⭐ | feat(examples): structured extraction from PDFs with GPT-4o vision + Pydantic validation loop | Codex fixes pushed Jun 21: registry.yaml entry and validation routing fixed. Waiting for re-review. |
| [#2811](https://github.com/openai/openai-cookbook/pull/2811) | **OpenAI Cookbook** | 12K ⭐ | feat(examples): model routing, cheapest capable OpenAI model dispatch with tiktoken cost tracking | Codex fixes pushed Jun 21: registry.yaml, API key setup, and router upgrade logic corrected. Waiting for re-review. |
...
| [#2813](https://github.com/openai/openai-cookbook/pull/2813) | **OpenAI Cookbook** | 12K ⭐ | feat(examples): multi-agent task decomposition, parallel specialists + asyncio.gather synthesis | All three Codex fixes pushed Jun 21: registry entry, asyncio.coroutine replaced, AsyncOpenAI client deferred. Waiting for re-review. |
