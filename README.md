...
| Repo | What it does | CLI package downloads |
|------|---------------|----------------------|
...
| [agent-eval](https://github.com/RudrenduPaul/agent-eval) | Runs your agent 50x on version A vs. B and gives a p-value on whether behavior actually shifted<br><br>· CLI: `agent-regress-cli`<br>· npm: [agent-regress-cli](https://www.npmjs.com/package/agent-regress-cli)<br>· PyPI: [agent-regress-cli](https://pypi.org/project/agent-regress-cli/) | 1,215 |
